...
def sender(p):
    ...
    # some code to drive the vehicle till the coordinate in "step" is reached
    # /mavros/rc/override mavros_msgs/OverrideRCIn '[1300, 1300, 1300, 1300, 0, 0, 0, 0]'
    rate = rospy.Rate(10) # 10 Hz
    pub = rospy.Publisher(rospy.get_namespace()+"mavros/rc/override mavros_msgs/OverrideRCIn", Int8MultiArray, queue_size=10)
    control_msg = [1300, 1300, 1300, 1300, 0, 0, 0, 0]
    # do sth to the msg
...
if __name__ == '__main__':
    ...
    rospy.init_node('move_to_next_step_rc_override.py')
